...
public class RoomsSuggestionsAdapter extends SuggestionsAdapter<RoomObject, RoomsSuggestionsAdapter.SuggestionHolder> {

    private RecyclerviewOnClickListener listener1;

    public RoomsSuggestionsAdapter(LayoutInflater inflater, RecyclerviewOnClickListener Listener) {
        super(inflater);
    ...
    public SuggestionHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = getLayoutInflater().inflate(R.layout.item_view_room_name, parent, false);
